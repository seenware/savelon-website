...
export function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    document.title = 'Savelon - Privacy Policy'
  }, [])
      ...
      <main>
        <Section>
          <article className="legal-page">
            ...
            <ul>
              <li>
                Consent, when you choose to submit the support form and optionally provide your
                email address.
              </li>
            ...
            <ul>
              ...
              <li>
                Legitimate interests, namely fraud prevention, purchase validation, and maintaining
                access to paid features.
              </li>
              <li>
                Legal obligations, where applicable for financial, tax, accounting, or consumer law
                compliance.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Other service providers only if necessary to operate support workflows or comply
